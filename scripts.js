...
function init() {
    ...
    function flightSimulator() {
        ...
        if (response) {
            let flightsStatus = document.getElementById("flightStatus").innerHTML = "Shuttle in flight.";
    ...
    //response.addEventListener("click",flightSimulator);
    ...
    function move_img_left() {
        //debugger;
        //imgObj.style.left = parseInt(imgObj.style.left) - '10px';
        imgObj.style.left = parseInt(imgObj.style.left) - 10 + 'px';
